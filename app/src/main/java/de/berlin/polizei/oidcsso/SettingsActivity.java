...
public class SettingsActivity extends AppCompatActivity {
    ...
    public static final String CHANNEL_ID = "Angemeldet";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        amgr.addOnAccountsUpdatedListener(listener, null, true, new String[]{getString(R.string.account_type)});
...
public void btnLogout(View v) {
   ...
   /* @Override
    ...
    private void initButtons() {
        ...
        });//Following Button declarations moved to the top of the code
        //now working with onClick methods directly in the button declaration
